package com.itheima.studentsystem02;
...
public class StudentSystem {
    ...
    public static void updateStudent(ArrayList<com.itheima.studentsystem.Student> list) {
        ...
        //获取要修改的学生对象
        com.itheima.studentsystem.Student stu = list.get(index);
    ...
    //判断id在集合中是否存在
    public static boolean contains(ArrayList<com.itheima.studentsystem.Student> list, String id) {
        //循环遍历集合得到里面的每一个学生对象
        /*for (int i = 0; i < list.size(); i++) {
            //拿到学生对象后，获取id并进行判断
